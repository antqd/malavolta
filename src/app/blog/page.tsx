...
const categories: Category[] = [
  {
    name: "Tecniche Colturali",
    slug: "tecniche-colturali",
    count: 24,
    color: "bg-primary",
  },
  {
    name: "Novità Prodotti",
    slug: "novita-prodotti",
    count: 18,
    color: "bg-secondary",
  },
  {
...
const featuredArticles: Article[] = [
  {
    ...
    excerpt:
      "Guida completa alle tecniche di preparazione del terreno per ottimizzare la resa delle colture autunnali. Scopri i metodi più efficaci per la lavorazione del suolo.",
  ...
  },
  {
    ...
    excerpt:
      "Analisi approfondita delle ultime varietà di mais disponibili sul mercato, con focus su resa, resistenza e adattabilità climatica.",
  ...
  },
  {
    ...
    excerpt:
      "Scopri come le nuove tecnologie di precisione stanno rivoluzionando il settore agricolo, migliorando efficienza e sostenibilità.",
    category: "Macchinari",
...
const recentArticles: Article[] = [
  {
    ...
    excerpt:
      "Strategie innovative per ottimizzare l'uso dell'acqua in agricoltura, riducendo sprechi e migliorando l'efficienza irrigua.",
  ...
  },
  {
    ...
    excerpt:
      "Tutto quello che devi sapere sulla fertilizzazione organica: tipologie, dosaggi e timing per massimizzare i benefici.",
    category: "Tecniche Colturali",
  ...
  },
  {
    ...
    excerpt:
      "Analisi dei prezzi dei principali cereali nel primo trimestre 2024 e previsioni per i prossimi mesi.",
  ...
  },
  {
    ...
    excerpt:
      "Metodi naturali ed ecologici per il controllo dei parassiti delle colture, riducendo l'uso di pesticidi chimici.",
    category: "Sostenibilità",
  ...
  },
  {
    ...
    excerpt:
      "Test approfondito della nuova gamma di trattori Case IH, con analisi di prestazioni, consumi e tecnologie integrate.",
    category: "Macchinari",
  ...
  },
  {
    ...
    excerpt:
      "Principi e strategie per una rotazione efficace delle colture che migliori la fertilità del suolo e riduca le malattie.",
    category: "Tecniche Colturali",
...
const trendingArticles: Article[] = [
  {
    ...
    excerpt:
      "Come utilizzare i droni per il monitoraggio delle colture e l'ottimizzazione degli interventi.",
    category: "Macchinari",
  ...
  },
  {
    ...
    excerpt:
      "Panoramica completa sul mercato del biologico, certificazioni necessarie e opportunità di business.",
    category: "Sostenibilità",
  ...
  },
  {
    ...
    excerpt:
      "Tecnologie IoT per il monitoraggio in tempo reale di parametri ambientali e colturali.",
    category: "Novità Prodotti",
        ...
        <div className="container relative z-10 text-center text-white">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg mb-10 max-w-2xl mx-auto opacity-80">
              Resta aggiornato sulle ultime tendenze, tecnologie e best
              practices del settore agricolo con i nostri esperti
            </p>
          ...
          <div className="flex items-center justify-between mb-12">
            <div>
              ...
              <p className="text-muted-foreground">
                I nostri contenuti più importanti e recenti
              </p>
            </div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              ...
              <p className="text-primary-foreground/80 mb-6">
                Il punto di riferimento per l'agricoltura italiana. Contenuti di
                qualità, consigli pratici e le ultime novità del settore
                agricolo.
              </p>
