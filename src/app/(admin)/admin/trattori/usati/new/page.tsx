...
export default function NuovoNew() {
  ...
  const submit = async (e:React.FormEvent)=> {
    ...
    try{
      ...
      const r = await fetch("/api/trattori/usati", { method:"POST", headers:{ "Content-Type":"application/json" }, body: JSON.stringify(body) });
  ...
  return (
    <div className="max-w-2xl">
      <h1 className="text-2xl font-semibold mb-4">Nuovo trattore (usati)</h1>
