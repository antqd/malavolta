      ...
      >
        ...
        <div className="relative container z-10 text-white">
          <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight">
            <span className={white}>I NOSTRI</span> <span className={gold}>SERVIZI</span>
          </h1>
        ...
        <div className="container space-y-8">
            ...
            <div className="grid md:grid-cols-2 gap-0">
              <div className={`${deepBlue} text-white p-8 md:p-12`}>
                <h2 className="text-3xl md:text-4xl font-extrabold">
                  <span className={gold}>POST</span> <span className={white}>VENDITA</span>
                </h2>
          ...
          <Card className="overflow-hidden border-border/50">
            <div className="grid md:grid-cols-2 gap-0">
              ...
              <div className={`${deepBlue} text-white p-8 md:p-12`}>
                <h2 className="text-3xl md:text-4xl font-extrabold">
                  <span className={gold}>FINANZIA</span><span className={white}>MENTI</span>
                </h2>
                <p className="mt-4 text-white/90 max-w-prose">
          ...
          <Card className="overflow-hidden border-border/50">
            <div className="grid md:grid-cols-2 gap-0">
              <div className={`${deepBlue} text-white p-8 md:p-12`}>
                <h2 className="text-3xl md:text-4xl font-extrabold">
                  <span className={gold}>OFFICINA</span> <span className={white}> MECCANICA </span>
                </h2>
                <p className="mt-4 text-white/90 max-w-prose">
          ...
          <Card className="overflow-hidden border-border/50">
            <div className="grid md:grid-cols-2 gap-0">
              ...
              <div className={`${deepBlue} text-white p-8 md:p-12`}>
                <h2 className="text-3xl md:text-4xl font-extrabold">
                  <span className={gold}>CONSUL</span><span className={white}>ENZA </span>
                </h2>
                <p className="mt-4 text-white/90 max-w-prose">
